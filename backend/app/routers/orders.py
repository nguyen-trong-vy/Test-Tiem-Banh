...
@router.post(
    ...
    description="Nhận thông tin người nhận, ngày giao, khung giờ, thiệp chúc và mảng sản phẩm. Xác thực qua JWT, kiểm tra đơn hàng >= 300.000đ và lưu vào bảng orders + order_items."
)
