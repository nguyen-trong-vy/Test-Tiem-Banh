...
import { CATEGORIES_DATA, PRODUCTS_DATA } from '../../data/bakeryData';
import { getProducts, getCategories } from '../../api/catalogApi';
import { useCart } from '../../context/CartContext';
import { ShoppingBag, Eye, ArrowUpDown, Filter, ChevronRight, Loader2 } from 'lucide-react';
...
export default function CategoryPage() {
  ...
  // Gọi API Backend FastAPI để lấy 22 sản phẩm từ Supabase
  useEffect(() => {
    let isMounted = true;
    async function fetchData() {
      try {
        ...
        console.warn('Chuyển sang chế độ dữ liệu offline dự phòng', error);
      } finally {
      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '2rem 1.5rem' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
            ...
            >
              Tất cả bánh ({PRODUCTS_DATA.length})
            </button>
