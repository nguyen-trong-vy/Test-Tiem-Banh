          ...
          <div style={{
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                ...
                <div>
                  <div style={{ fontWeight: '700', fontSize: '0.92rem' }}>Gian Hàng Khách Hàng</div>
                  <div style={{ fontSize: '0.75rem', color: '#78716C' }}>Xem giao diện đặt bánh</div>
                </div>
              </div>
